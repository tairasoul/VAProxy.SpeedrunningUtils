...
Also needs [VAProxy.PageFramework](https://github.com/tairasoul/VAProxy.PageFramework) to integrate into the actual game UI for settings. It is included by default though.
